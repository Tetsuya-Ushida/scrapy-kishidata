...
class KishiSpider(scrapy.Spider):
    ...
    def start_requests(self):
        yield scrapy.Request(
            url='https://www.shogi.or.jp/player/numerical_order.html', 
            callback=self.parse
    )
    ...
    def parse_kishi(self, response):
        ...
        kishi.add_xpath('name_ja', '//div[@class="nameArea"]//h1[@class="nameTtl"]//span[@class="jp"]/text()')
        kishi.add_xpath('name_en', '//div[@class="nameArea"]//h1[@class="nameTtl"]//span[@class="en"]/text()')
        kishi.add_xpath('dani','//p[contains(@class,"headingElementsA01")]//text()')
